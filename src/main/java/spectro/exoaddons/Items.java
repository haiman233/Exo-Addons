...
public final class Items {
    ...
    public static final SlimefunItemStack EXO_NANO_HELMET = new SlimefunItemStack(
            ...
            "&b&l-> &&Precisa de todas as partes!",
            "&c&o&8\u21E8 &e\u26A1 &70 / 10000 J",
            "",
            "&9⛏ &aSky-Factory &9⛏"
    );
    ...
    public static void setup(ExoAddons plugin) {
        ...
        //Nano Helmet recipe
        new NanoHelmet(category, EXO_NANO_HELMET, RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] {
        ...
        new NanoChestplate(category, EXO_NANO_CHESTPLATE, RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] {
        ...
        new NanoLeggings(category, EXO_NANO_LEGGINGS, RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] {
                new ItemStack(Material.IRON_BLOCK), null, new ItemStack(Material.IRON_INGOT),
        ...
        //Nano Boots recipe
        new NanoBoots(category, EXO_NANO_BOOTS, RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] {
